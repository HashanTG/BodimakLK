...
>
  <div className="welcome-container">
    ...
    <p className="welcome-highlight">
      At bodimak.lk, we simplify the entire process of finding, renting, and managing rooms.
    </p>
...
>
    ...
    {[
      {
        ...
        description: 'Discover Your Next Room\nFind Your Match\nStay Updated',
      },
      {
  ...
  <div className="yellow-card-image">
    <img src="src/assets/Rectangle 10.png" alt="Highlight Section Image" />
  </div>
</motion.section>
